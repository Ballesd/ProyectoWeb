            ...
            <div>
                <div>
                    <div class="flex justify-around py-5 mb-5">
                        ...
                        <div>
                            <a href="{{ route('descarga_excel') }}" data-placement="left">
                                <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"><i class="fa-solid fa-download"></i> {{ __('Generar Excel de emplados (XLSX)') }}</button>
                            </a>
                        </div>
                        <div>
